...
public interface DatabaseConstants {
    ...
    // Connector constant
    public static String CONST_CNTR_SQLSERVER_CLASS = "oracle.jdbc.OracleDriver";
    ...
    public static String CONST_CNTR_SQLSERVER_TABLENAMES = "select t.table_name,t.comments, t.TABLE_TYPE from user_tab_comments t";
    public static String CONST_CNTR_SQLSERVER_TABLECOLUMNS = "select t.COLUMN_NAME, t.DATA_TYPE, t.DATA_LENGTH from user_tab_columns t where t.TABLE_NAME = '%s'";
