...
public interface Constants extends DBConstants {
    ...
    public String SQL_QUERY_RESULT = "SELECT scn,operation,timestamp,status,sql_redo FROM v$logmnr_contents WHERE seg_type_name='TABLE' AND operation !='SELECT_FOR_UPDATE'";
