 ...
 */
public class DatabaseConnector implements Connector, DatabaseConstants {
    ...
    public void open() {
        ...
        dbClient = new OracleClient(ojdbcURL, connURL, user, password, letterUpper);
        dbClient.open();
    ...
    public void setPropertyList(Map<String, Value> propertyList) {
        ...
        if (propertyList.containsKey(LETTER_UPPER)) {
            letterUpper = propertyList.get(LETTER_UPPER).getBoolean();
        }
    }
}
