...
public class MapperTest {
    ...
    public void testElementMapping() throws Exception {
        ...
        rule.getRuleItem("WareHouse.name").setScript("$SetCarrier('test', 'hello carrier');\n@Person.name");
        ...
        rule_Final.getRuleItem("Final.name").setScript("$LogInfo('Test carrier value: ' + $GetCarrier('test'));\n if(!$GetCarrier('test')) throw 'No carrier for test';\n@WareHouse.name");
