...
public class TransformExecuteContext implements ExecuteContext {
    ...
    public TransformExecuteContext(String targetName) {
        this(null, targetName, new ArrayList<InspectionHander>(1));
    }

    public TransformExecuteContext(TransformComponent target, String targetFmtName, List<InspectionHander> handlers) {
        this(null, null, target, targetFmtName, handlers);
    }

    public TransformExecuteContext(ExecuteContext parentCtx, ElementChunk chunk, TransformComponent target, String targetFmtName, List<InspectionHander> handlers) {
    ...
    public TransformExecuteContext addHandler(InspectionHander handler) {
