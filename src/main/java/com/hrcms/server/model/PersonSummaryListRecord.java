...
public class PersonSummaryListRecord {
    public static final String SQL_ALL = "SELECT A.职工号,A.姓名, A.性别, A.出生日期, A.身份证号, B.名称 AS 民族, A.来校年月, A.参加工作年月, A.健康状况, A.外侨情况, A.婚姻状况, A.来源类别, A. 编制类别, A.人员类别 FROM 个人概况 A, DICT_民族名称代码 B WHERE A.民族＝B.代码(+)";
