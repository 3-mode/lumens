...
*/
(function(b){b.jgrid=b.jgrid||{};b.extend(b.jgrid,{version:"4.5.1",htmlDecode:function(b){return b&&("&nbsp;"===b||"&#160;"===b||1===b.length&&160===b.charCodeAt(0))?"":!b?b:(""+b).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&")},htmlEncode:function(b){return!b?b:(""+b).replace(/&/g,"&amp;").replace(/\"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},format:function(d){var f=b.makeArray(arguments).slice(1);null==d&&(d="");return d.replace(/\{(\d+)\}/g,
...
c||(c="Y-m-d");d=h.getHours();f=h.getMinutes();g=h.getDate();j=h.getMonth()+1;i=h.getTimezoneOffset();k=h.getSeconds();var m=h.getMilliseconds(),n=h.getDay(),p=h.getFullYear(),l=(n+6)%7+1,o=(new Date(p,j-1,g)-new Date(p,0,1))/864E5,B={d:a(g),D:e.dayNames[n],j:g,l:e.dayNames[n+7],N:l,S:e.S(g),w:n,z:o,W:5>l?Math.floor((o+l-1)/7)+1:Math.floor((o+l-1)/7)||(4>((new Date(p-1,0,1)).getDay()+6)%7?53:52),F:e.monthNames[j-1+12],m:a(j),M:e.monthNames[j-1],n:j,t:"?",L:"?",o:"?",Y:p,y:(""+p).substring(2),a:12>
d?e.AmPm[0]:e.AmPm[1],A:12>d?e.AmPm[2]:e.AmPm[3],B:"?",g:d%12||12,G:d,h:a(d%12||12),H:a(d),i:a(f),s:a(k),u:m,e:"?",I:"?",O:(0<i?"-":"+")+a(100*Math.floor(Math.abs(i)/60)+Math.abs(i)%60,4),P:"?",T:((""+h).match(/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g)||[""]).pop().replace(/[^-+\dA-Z]/g,""),Z:"?",c:"?",r:"?",U:Math.floor(h/1E3)};return c.replace(/\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,function(a){return B.hasOwnProperty(a)?
B[a]:a.substring(1)})},jqID:function(b){return(""+b).replace(/[!"#$%&'()*+,.\/:; <=>?@\[\\\]\^`{|}~]/g,"\\$&")},guid:1,uidPref:"jqg",randId:function(d){return(d||b.jgrid.uidPref)+b.jgrid.guid++},getAccessor:function(b,f){var c,e,a=[],j;if("function"===typeof f)return f(b);c=b[f];if(void 0===c)try{if("string"===typeof f&&(a=f.split(".")),j=a.length)for(c=b;c&&j--;)e=a.shift(),c=c[e]}catch(g){}return c},getXmlData:function(d,f,c){var e="string"===typeof f?f.match(/^(.*)\[(\w+)\]$/):null;if("function"===
...
o.length&&(a=e._doSort(a,0))};this._doSort=function(a,b){var d=o[b].by,g=o[b].dir,j=o[b].type,c=o[b].datefmt;if(b===o.length-1)return e._getOrder(a,d,g,j,c);b++;for(var d=e._getGroup(a,d,g,j,c),g=[],f,j=0;j<d.length;j++){f=e._doSort(d[j].items,b);for(c=0;c<f.length;c++)g.push(f[c])}return g};this._getOrder=function(a,d,g,c,f){var h=[],k=[],m="a"===g?1:-1,n,p;void 0===c&&(c="text");p="float"===c||"number"===c||"currency"===c||"numeric"===c?function(a){a=parseFloat((""+a).replace(i,""));return isNaN(a)?
0:a}:"int"===c||"integer"===c?function(a){return a?parseFloat((""+a).replace(i,"")):0}:"date"===c||"datetime"===c?function(a){return b.jgrid.parseDate(f,a).getTime()}:b.isFunction(c)?c:function(a){a=a?b.trim(""+a):"";return j?a:a.toLowerCase()};b.each(a,function(a,e){n=""!==d?b.jgrid.getAccessor(e,d):e;void 0===n&&(n="");n=p(n,e);k.push({vSort:n,index:a})});k.sort(function(a,b){a=a.vSort;b=b.vSort;return e._compare(a,b,m)});for(var c=0,l=a.length;c<l;)g=k[c].index,h.push(a[g]),c++;return h};this._getGroup=
...
b,d)};this.or=function(a,b,d){l=" || ";return void 0===a?e:e._repeatCommand(a,b,d)};this.orBegin=function(){n++;return e};this.orEnd=function(){null!==h&&(h+=")");return e};this.isNot=function(a){p=!p;return e.is(a)};this.is=function(a){e._append("this."+a);e._resetNegate();return e};this._compareValues=function(a,d,g,j,c){var f;f=B?"jQuery.jgrid.getAccessor(this,'"+d+"')":"this";void 0===g&&(g=null);var h=g,k=void 0===c.stype?"text":c.stype;if(null!==g)switch(k){case "int":case "integer":h=isNaN(Number(h))||
...
f;var h=e.rowNum;g=c.scrollTop=c.bDiv.scrollTop;var i=Math.round(d.position().top)-g,k=i+d.height();f*=h;var A,G,w;if(k<a&&0>=i&&(void 0===e.lastpage||parseInt((k+g+f-1)/f,10)<=e.lastpage))G=parseInt((a-k+f-1)/f,10),0<=k||2>G||!0===e.scroll?(A=Math.round((k+g)/f)+1,i=-1):i=1;0<i&&(A=parseInt(g/f,10)+1,G=parseInt((g+a)/f,10)+2-A,w=!0);if(G&&(!e.lastpage||!(A>e.lastpage||1===e.lastpage||A===e.page&&A===e.lastpage)))c.hDiv.loading?c.timer=setTimeout(c.populateVisible,e.scrollTimeout):(e.page=A,w&&(c.selectionPreserver(d[0]),
...
var m=b("<div class='ui-jqgrid ui-widget ui-widget-content ui-corner-all'></div>");b(m).attr({id:"gbox_"+this.id,dir:f}).insertBefore(i);b(i).attr("id","gview_"+this.id).appendTo(m);b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_"+this.id+"'></div>").insertBefore(i);b("<div class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(i);b(this).attr({cellspacing:"0",cellpadding:"0",border:"0",role:"grid","aria-multiselectable":!!this.p.multiselect,
"aria-labelledby":"gbox_"+this.id});var n=function(a,b){a=parseInt(a,10);return isNaN(a)?b||0:a},p=function(d,e,g,f,h,i){var Q=a.p.colModel[d],k=Q.align,A='style="',G=Q.classes,w=Q.name,x=[];k&&(A=A+("text-align:"+k+";"));Q.hidden===true&&(A=A+"display:none;");if(e===0)A=A+("width: "+c.headers[d].width+"px;");else if(Q.cellattr&&b.isFunction(Q.cellattr))if((d=Q.cellattr.call(a,h,g,f,Q,i))&&typeof d==="string"){d=d.replace(/style/i,"style").replace(/title/i,"title");if(d.indexOf("title")>-1)Q.title=
false;d.indexOf("class")>-1&&(G=void 0);x=d.split(/[^-]style/);if(x.length===2){x[1]=b.trim(x[1].replace("=",""));if(x[1].indexOf("'")===0||x[1].indexOf('"')===0)x[1]=x[1].substring(1);A=A+x[1].replace(/'/gi,'"')}else A=A+'"'}if(!x.length){x[0]="";A=A+'"'}A=A+((G!==void 0?' class="'+G+'"':"")+(Q.title&&g?' title="'+b.jgrid.stripHtml(g)+'"':""));A=A+(' aria-describedby="'+a.p.id+"_"+w+'"');return A+x[0]},l=function(c){return c==null||c===""?"&#160;":a.p.autoencode?b.jgrid.htmlEncode(c):""+c},o=function(c,
d,e,g,f){var h=a.p.colModel[e];if(h.formatter!==void 0){c=""+a.p.idPrefix!==""?b.jgrid.stripPref(a.p.idPrefix,c):c;c={rowId:c,colModel:h,gid:a.p.id,pos:e};d=b.isFunction(h.formatter)?h.formatter.call(a,d,c,g,f):b.fmatter?b.fn.fmatter.call(a,h.formatter,d,c,g,f):l(d)}else d=l(d);return d},B=function(a,b,c,d,e,g){b=o(a,b,c,e,"add");return'<td role="gridcell" '+p(c,d,b,e,a,g)+">"+b+"</td>"},S=function(b,c,d,e){e='<input role="checkbox" type="checkbox" id="jqg_'+a.p.id+"_"+b+'" class="cbox" name="jqg_'+
...
0}if(c===true&&this.p.treeGrid){this.p.data=[];this.p._index={}}},M=function(){var c=a.p.data.length,d,e,g;d=a.p.rownumbers===true?1:0;e=a.p.multiselect===true?1:0;g=a.p.subGrid===true?1:0;d=a.p.keyIndex===false||a.p.loadonce===true?a.p.localReader.id:a.p.colModel[a.p.keyIndex+e+g+d].name;for(e=0;e<c;e++){g=b.jgrid.getAccessor(a.p.data[e],d);g===void 0&&(g=""+(e+1));a.p._index[g]=e}},W=function(c,d,e,g,f,h){var j="-1",i="",k,d=d?"display:none;":"",e="ui-widget-content jqgrow ui-row-"+a.p.direction+
(e?" "+e:"")+(h?" ui-state-highlight":""),h=b(a).triggerHandler("jqGridRowAttr",[g,f,c]);typeof h!=="object"&&(h=b.isFunction(a.p.rowattr)?a.p.rowattr.call(a,g,f,c):{});if(!b.isEmptyObject(h)){if(h.hasOwnProperty("id")){c=h.id;delete h.id}if(h.hasOwnProperty("tabindex")){j=h.tabindex;delete h.tabindex}if(h.hasOwnProperty("style")){d=d+h.style;delete h.style}if(h.hasOwnProperty("class")){e=e+(" "+h["class"]);delete h["class"]}try{delete h.role}catch(G){}for(k in h)h.hasOwnProperty(k)&&(i=i+(" "+k+
...
""))||b};a.p.userData={};a.p.page=b.jgrid.getXmlData(c,i.page)||a.p.page||0;a.p.lastpage=b.jgrid.getXmlData(c,i.total);if(a.p.lastpage===void 0)a.p.lastpage=1;a.p.records=b.jgrid.getXmlData(c,i.records)||0;b.isFunction(i.userdata)?a.p.userData=i.userdata.call(a,c)||{}:b.jgrid.getXmlData(c,i.userdata,true).each(function(){a.p.userData[this.getAttribute("name")]=b(this).text()});c=b.jgrid.getXmlData(c,i.root,true);(c=b.jgrid.getXmlData(c,i.row,true))||(c=[]);var v=c.length,K=0,C=[],D=parseInt(a.p.rowNum,
10),H=a.p.scroll?b.jgrid.randId():1;if(v>0&&a.p.page<=0)a.p.page=1;if(c&&v){f&&(D=D*(f+1));var f=b.isFunction(a.p.afterInsertRow),J=false,I;if(a.p.grouping){J=a.p.groupingView.groupCollapse===true;I=b.jgrid.getMethod("groupingPrepare")}for(;K<v;){z=c[K];E=k(z,H+K);E=a.p.idPrefix+E;w=e===0?0:e+1;t=(w+K)%2===1?qa:"";var N=r.length;r.push("");l&&r.push(L(0,K,a.p.page,a.p.rowNum));s&&r.push(S(E,l,K,false));y&&r.push(p.call(G,s+l,K+e));if(i.repeatitems){F||(F=T(s+y+l));var M=b.jgrid.getXmlData(z,i.cell,
true);b.each(F,function(b){var c=M[this];if(!c)return false;n=c.textContent||c.text;q[a.p.colModel[b+s+y+l].name]=n;r.push(B(E,n,b+s+y+l,K+e,z,q))})}else for(w=0;w<u.length;w++){n=b.jgrid.getXmlData(z,u[w]);q[a.p.colModel[w+s+y+l].name]=n;r.push(B(E,n,w+s+y+l,K+e,z,q))}r[N]=W(E,J,t,q,z,false);r.push("</tr>");if(a.p.grouping){C=I.call(G,r,C,q,K);r=[]}if(j||a.p.treeGrid===true){q._id_=b.jgrid.stripPref(a.p.idPrefix,E);a.p.data.push(q);a.p._index[q._id_]=a.p.data.length-1}if(a.p.gridview===false){b("tbody:first",
d).append(r.join(""));G.triggerHandler("jqGridAfterInsertRow",[E,q,z]);f&&a.p.afterInsertRow.call(a,E,q,z);r=[]}q={};m++;K++;if(m===D)break}}if(a.p.gridview===true){x=a.p.treeANode>-1?a.p.treeANode:0;if(a.p.grouping){G.jqGrid("groupingRender",C,a.p.colModel.length);C=null}else a.p.treeGrid===true&&x>0?b(a.rows[x]).after(r.join("")):b("tbody:first",d).append(r.join(""))}if(a.p.subGrid===true)try{G.jqGrid("addSubGrid",s+l)}catch(P){}a.p.totaltime=new Date-h;if(m>0&&a.p.records===0)a.p.records=v;r=null;
if(a.p.treeGrid===true)try{G.jqGrid("setTreeNode",x+1,m+x+1)}catch(R){}if(!a.p.treeGrid&&!a.p.scroll)a.grid.bDiv.scrollTop=0;a.p.reccount=m;a.p.treeANode=-1;a.p.userDataOnFooter&&G.jqGrid("footerData","set",a.p.userData,true);if(j){a.p.records=v;a.p.lastpage=Math.ceil(v/D)}g||a.updatepager(false,true);if(j)for(;m<v;){z=c[m];E=k(z,m+H);E=a.p.idPrefix+E;if(i.repeatitems){F||(F=T(s+y+l));var O=b.jgrid.getXmlData(z,i.cell,true);b.each(F,function(b){var c=O[this];if(!c)return false;n=c.textContent||c.text;
q[a.p.colModel[b+s+y+l].name]=n})}else for(w=0;w<u.length;w++){n=b.jgrid.getXmlData(z,u[w]);q[a.p.colModel[w+s+y+l].name]=n}q._id_=b.jgrid.stripPref(a.p.idPrefix,E);a.p.data.push(q);a.p._index[q._id_]=a.p.data.length-1;q={};m++}}},R=function(c,d,e,g,f){var h=new Date;if(c){if(a.p.treeANode===-1&&!a.p.scroll){U.call(a,false,true);e=1}else e=e>1?e:1;var i,j=a.p.datatype!=="local"&&a.p.loadonce||a.p.datatype==="jsonstring";if(j){a.p.data=[];a.p._index={};a.p.localReader.id="_id_"}a.p.reccount=0;if(a.p.datatype===
...
{};q=a.p.keyIndex===false?b.isFunction(d.id)?d.id.call(a,c):d.id:a.p.keyIndex;if(!d.repeatitems){l=i;if(l.length>0&&!isNaN(q)){a.p.remapColumns&&a.p.remapColumns.length&&(q=b.inArray(q,a.p.remapColumns));q=l[q]}}F=b.jgrid.getAccessor(c,d.root);F==null&&b.isArray(c)&&(F=c);F||(F=[]);c=F.length;x=0;if(c>0&&a.p.page<=0)a.p.page=1;var K=parseInt(a.p.rowNum,10),H=a.p.scroll?b.jgrid.randId():1,J=false,I;f&&(K=K*(f+1));a.p.datatype==="local"&&!a.p.deselectAfterSort&&(J=true);var N=b.isFunction(a.p.afterInsertRow),
M=[],O=false,P;if(a.p.grouping){O=a.p.groupingView.groupCollapse===true;P=b.jgrid.getMethod("groupingPrepare")}for(;x<c;){f=F[x];r=b.jgrid.getAccessor(f,q);if(r===void 0){typeof q==="number"&&a.p.colModel[q+s+y+o]!=null&&(r=b.jgrid.getAccessor(f,a.p.colModel[q+s+y+o].name));if(r===void 0){r=H+x;if(l.length===0&&d.cell){w=b.jgrid.getAccessor(f,d.cell)||f;r=w!=null&&w[q]!==void 0?w[q]:r}}}r=a.p.idPrefix+r;w=e===1?0:e;D=(w+x)%2===1?C:"";J&&(I=a.p.multiselect?b.inArray(r,a.p.selarrrow)!==-1:r===a.p.selrow);
var R=t.length;t.push("");o&&t.push(L(0,x,a.p.page,a.p.rowNum));s&&t.push(S(r,o,x,I));y&&t.push(p.call(k,s+o,x+e));v=i;if(d.repeatitems){d.cell&&(f=b.jgrid.getAccessor(f,d.cell)||f);b.isArray(f)&&(v=u)}for(n=0;n<v.length;n++){w=b.jgrid.getAccessor(f,v[n]);z[a.p.colModel[n+s+y+o].name]=w;t.push(B(r,w,n+s+y+o,x+e,f,z))}t[R]=W(r,O,D,z,f,I);t.push("</tr>");if(a.p.grouping){M=P.call(k,t,M,z,x);t=[]}if(j||a.p.treeGrid===true){z._id_=b.jgrid.stripPref(a.p.idPrefix,r);a.p.data.push(z);a.p._index[z._id_]=
a.p.data.length-1}if(a.p.gridview===false){b("#"+b.jgrid.jqID(a.p.id)+" tbody:first").append(t.join(""));k.triggerHandler("jqGridAfterInsertRow",[r,z,f]);N&&a.p.afterInsertRow.call(a,r,z,f);t=[]}z={};m++;x++;if(m===K)break}if(a.p.gridview===true){E=a.p.treeANode>-1?a.p.treeANode:0;a.p.grouping?k.jqGrid("groupingRender",M,a.p.colModel.length):a.p.treeGrid===true&&E>0?b(a.rows[E]).after(t.join("")):b("#"+b.jgrid.jqID(a.p.id)+" tbody:first").append(t.join(""))}if(a.p.subGrid===true)try{k.jqGrid("addSubGrid",
s+o)}catch($){}a.p.totaltime=new Date-h;if(m>0&&a.p.records===0)a.p.records=c;if(a.p.treeGrid===true)try{k.jqGrid("setTreeNode",E+1,m+E+1)}catch(V){}if(!a.p.treeGrid&&!a.p.scroll)a.grid.bDiv.scrollTop=0;a.p.reccount=m;a.p.treeANode=-1;a.p.userDataOnFooter&&k.jqGrid("footerData","set",a.p.userData,true);if(j){a.p.records=c;a.p.lastpage=Math.ceil(c/K)}g||a.updatepager(false,true);if(j)for(;m<c&&F[m];){f=F[m];r=b.jgrid.getAccessor(f,q);if(r===void 0){typeof q==="number"&&a.p.colModel[q+s+y+o]!=null&&
(r=b.jgrid.getAccessor(f,a.p.colModel[q+s+y+o].name));if(r===void 0){r=H+m;if(l.length===0&&d.cell){e=b.jgrid.getAccessor(f,d.cell)||f;r=e!=null&&e[q]!==void 0?e[q]:r}}}if(f){r=a.p.idPrefix+r;v=i;if(d.repeatitems){d.cell&&(f=b.jgrid.getAccessor(f,d.cell)||f);b.isArray(f)&&(v=u)}for(n=0;n<v.length;n++)z[a.p.colModel[n+s+y+o].name]=b.jgrid.getAccessor(f,v[n]);z._id_=b.jgrid.stripPref(a.p.idPrefix,r);a.p.data.push(z);a.p._index[z._id_]=a.p.data.length-1;z={}}m++}}},ia=function(){function c(a){var b=
0,d,e,g,h,i;if(a.groups!=null){(e=a.groups.length&&a.groupOp.toString().toUpperCase()==="OR")&&s.orBegin();for(d=0;d<a.groups.length;d++){b>0&&e&&s.or();try{c(a.groups[d])}catch(j){alert(j)}b++}e&&s.orEnd()}if(a.rules!=null)try{(g=a.rules.length&&a.groupOp.toString().toUpperCase()==="OR")&&s.orBegin();for(d=0;d<a.rules.length;d++){i=a.rules[d];h=a.groupOp.toString().toUpperCase();if(o[i.op]&&i.field){b>0&&h&&h==="OR"&&(s=s.or());s=o[i.op](s,h)(i.field,i.data,f[i.field])}b++}g&&s.orEnd()}catch(pa){alert(pa)}}
var d=a.p.multiSort?[]:"",e=[],g=false,f={},h=[],i=[],j,k,m;if(b.isArray(a.p.data)){var n=a.p.grouping?a.p.groupingView:false,x,l;b.each(a.p.colModel,function(){k=this.sorttype||"text";if(k==="date"||k==="datetime"){if(this.formatter&&typeof this.formatter==="string"&&this.formatter==="date"){j=this.formatoptions&&this.formatoptions.srcformat?this.formatoptions.srcformat:b.jgrid.formatter.date.srcformat;m=this.formatoptions&&this.formatoptions.newformat?this.formatoptions.newformat:b.jgrid.formatter.date.newformat}else j=
m=this.datefmt||"Y-m-d";f[this.name]={stype:k,srcfmt:j,newfmt:m}}else f[this.name]={stype:k,srcfmt:"",newfmt:""};if(a.p.grouping){l=0;for(x=n.groupField.length;l<x;l++)if(this.name===n.groupField[l]){var c=this.name;if(this.index)c=this.index;h[l]=f[c];i[l]=c}}if(a.p.multiSort){if(this.lso){d.push(this.name);c=this.lso.split("-");e.push(c[c.length-1])}}else if(!g&&(this.index===a.p.sortname||this.name===a.p.sortname)){d=this.name;g=true}});if(a.p.treeGrid)b(a).jqGrid("SortTree",d,a.p.sortorder,f[d].stype,
f[d].srcfmt);else{var o={eq:function(a){return a.equals},ne:function(a){return a.notEquals},lt:function(a){return a.less},le:function(a){return a.lessOrEquals},gt:function(a){return a.greater},ge:function(a){return a.greaterOrEquals},cn:function(a){return a.contains},nc:function(a,b){return b==="OR"?a.orNot().contains:a.andNot().contains},bw:function(a){return a.startsWith},bn:function(a,b){return b==="OR"?a.orNot().startsWith:a.andNot().startsWith},en:function(a,b){return b==="OR"?a.orNot().endsWith:
...
f[a.p.postData.searchField])}catch(p){}}if(a.p.grouping)for(l=0;l<x;l++)s.orderBy(i[l],n.groupOrder[l],h[l].stype,h[l].srcfmt);a.p.multiSort?b.each(d,function(a){s.orderBy(this,e[a],f[this].stype,f[this].srcfmt)}):d&&a.p.sortorder&&g&&(a.p.sortorder.toUpperCase()==="DESC"?s.orderBy(a.p.sortname,"d",f[d].stype,f[d].srcfmt):s.orderBy(a.p.sortname,"a",f[d].stype,f[d].srcfmt));var y=s.select(),t=parseInt(a.p.rowNum,10),u=y.length,v=parseInt(a.p.page,10),B=Math.ceil(u/t),q={},y=y.slice((v-1)*t,v*t),f=
s=null;q[a.p.localReader.total]=B;q[a.p.localReader.page]=v;q[a.p.localReader.records]=u;q[a.p.localReader.root]=y;q[a.p.localReader.userdata]=a.p.userData;y=null;return q}}},$=function(){a.grid.hDiv.loading=true;if(!a.p.hiddengrid)switch(a.p.loadui){case "enable":b("#load_"+b.jgrid.jqID(a.p.id)).show();break;case "block":b("#lui_"+b.jgrid.jqID(a.p.id)).show();b("#load_"+b.jgrid.jqID(a.p.id)).show()}},O=function(){a.grid.hDiv.loading=false;switch(a.p.loadui){case "enable":b("#load_"+b.jgrid.jqID(a.p.id)).hide();
break;case "block":b("#lui_"+b.jgrid.jqID(a.p.id)).hide();b("#load_"+b.jgrid.jqID(a.p.id)).hide()}},N=function(c){if(!a.grid.hDiv.loading){var d=a.p.scroll&&c===false,e={},g,f=a.p.prmNames;if(a.p.page<=0)a.p.page=1;if(f.search!==null)e[f.search]=a.p.search;f.nd!==null&&(e[f.nd]=(new Date).getTime());if(f.rows!==null)e[f.rows]=a.p.rowNum;if(f.page!==null)e[f.page]=a.p.page;if(f.sort!==null)e[f.sort]=a.p.sortname;if(f.order!==null)e[f.order]=a.p.sortorder;if(a.p.rowTotal!==null&&f.totalrows!==null)e[f.totalrows]=
a.p.rowTotal;var h=b.isFunction(a.p.loadComplete),i=h?a.p.loadComplete:null,j=0,c=c||1;if(c>1)if(f.npage!==null){e[f.npage]=c;j=c-1;c=1}else i=function(b){a.p.page++;a.grid.hDiv.loading=false;h&&a.p.loadComplete.call(a,b);N(c-1)};else f.npage!==null&&delete a.p.postData[f.npage];if(a.p.grouping){b(a).jqGrid("groupingSetup");var k=a.p.groupingView,m,n="";for(m=0;m<k.groupField.length;m++){var l=k.groupField[m];b.each(a.p.colModel,function(a,b){if(b.name===l&&b.index)l=b.index});n=n+(l+" "+k.groupOrder[m]+
", ")}e[f.sort]=n+e[f.sort]}b.extend(a.p.postData,e);var o=!a.p.scroll?1:a.rows.length-1,e=b(a).triggerHandler("jqGridBeforeRequest");if(!(e===false||e==="stop"))if(b.isFunction(a.p.datatype))a.p.datatype.call(a,a.p.postData,"load_"+a.p.id);else{if(b.isFunction(a.p.beforeRequest)){e=a.p.beforeRequest.call(a);e===void 0&&(e=true);if(e===false)return}g=a.p.datatype.toLowerCase();switch(g){case "json":case "jsonp":case "xml":case "script":b.ajax(b.extend({url:a.p.url,type:a.p.mtype,dataType:g,data:b.isFunction(a.p.serializeGridData)?
a.p.serializeGridData.call(a,a.p.postData):a.p.postData,success:function(e,f,h){if(b.isFunction(a.p.beforeProcessing)&&a.p.beforeProcessing.call(a,e,f,h)===false)O();else{g==="xml"?J(e,a.grid.bDiv,o,c>1,j):R(e,a.grid.bDiv,o,c>1,j);b(a).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(a,e);b(a).triggerHandler("jqGridAfterLoadComplete",[e]);d&&a.grid.populateVisible();if(a.p.loadonce||a.p.treeGrid)a.p.datatype="local";c===1&&O()}},error:function(d,e,f){b.isFunction(a.p.loadError)&&a.p.loadError.call(a,
d,e,f);c===1&&O()},beforeSend:function(c,d){var e=true;b.isFunction(a.p.loadBeforeSend)&&(e=a.p.loadBeforeSend.call(a,c,d));e===void 0&&(e=true);if(e===false)return false;$()}},b.jgrid.ajaxOptions,a.p.ajaxGridOptions));break;case "xmlstring":$();e=typeof a.p.datastr!=="string"?a.p.datastr:b.parseXML(a.p.datastr);J(e,a.grid.bDiv);b(a).triggerHandler("jqGridLoadComplete",[e]);h&&a.p.loadComplete.call(a,e);b(a).triggerHandler("jqGridAfterLoadComplete",[e]);a.p.datatype="local";a.p.datastr=null;O();break;
case "jsonstring":$();e=typeof a.p.datastr==="string"?b.jgrid.parse(a.p.datastr):a.p.datastr;R(e,a.grid.bDiv);b(a).triggerHandler("jqGridLoadComplete",[e]);h&&a.p.loadComplete.call(a,e);b(a).triggerHandler("jqGridAfterLoadComplete",[e]);a.p.datatype="local";a.p.datastr=null;O();break;case "local":case "clientside":$();a.p.datatype="local";e=ia();R(e,a.grid.bDiv,o,c>1,j);b(a).triggerHandler("jqGridLoadComplete",[e]);i&&i.call(a,e);b(a).triggerHandler("jqGridAfterLoadComplete",[e]);d&&a.grid.populateVisible();
O()}}}},ba=function(c){b("#cb_"+b.jgrid.jqID(a.p.id),a.grid.hDiv)[a.p.useProp?"prop":"attr"]("checked",c);if(a.p.frozenColumns&&a.p.id+"_frozen")b("#cb_"+b.jgrid.jqID(a.p.id),a.grid.fhDiv)[a.p.useProp?"prop":"attr"]("checked",c)},ja=function(c,d){var e="",g="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",i="",j,k,m,l,o=function(c){var d;b.isFunction(a.p.onPaging)&&(d=a.p.onPaging.call(a,c));a.p.selrow=null;if(a.p.multiselect){a.p.selarrrow=
...
b("#first"+b.jgrid.jqID(d)+", #prev"+b.jgrid.jqID(d)+", #next"+b.jgrid.jqID(d)+", #last"+b.jgrid.jqID(d)).click(function(){var b=n(a.p.page,1),c=n(a.p.lastpage,1),e=false,g=true,f=true,h=true,i=true;if(c===0||c===1)i=h=f=g=false;else if(c>1&&b>=1)if(b===1)f=g=false;else{if(b===c)i=h=false}else if(c>1&&b===0){i=h=false;b=c-1}if(!o(this.id))return false;if(this.id==="first"+d&&g){a.p.page=1;e=true}if(this.id==="prev"+d&&f){a.p.page=b-1;e=true}if(this.id==="next"+d&&h){a.p.page=b+1;e=true}if(this.id===
"last"+d&&i){a.p.page=c;e=true}e&&N();return false})}a.p.pginput===true&&b("input.ui-pg-input","#"+j).keypress(function(c){if((c.charCode||c.keyCode||0)===13){if(!o("user"))return false;b(this).val(n(b(this).val(),1));a.p.page=b(this).val()>0?b(this).val():a.p.page;N();return false}return this})},ra=function(c,d){var e,g="",f=a.p.colModel,h=false,i;i=a.p.frozenColumns?d:a.grid.headers[c].el;var j="";b("span.ui-grid-ico-sort",i).addClass("ui-state-disabled");b(i).attr("aria-selected","false");if(f[c].lso)if(f[c].lso===
...
b.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!0,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},a.p.jsonReader);a.p.localReader=b.extend(!0,{root:"rows",page:"page",total:"total",records:"records",repeatitems:!1,cell:"cell",id:"id",userdata:"userdata",subgrid:{root:"rows",repeatitems:!0,cell:"cell"}},a.p.localReader);a.p.scroll&&(a.p.pgbuttons=!1,a.p.pginput=!1,a.p.rowList=[]);a.p.data.length&&M();var C="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",
ma,D,ca,da,ea,t,u,V,na=V="",aa=[],oa=[];D=[];if(!0===a.p.shrinkToFit&&!0===a.p.forceFit)for(g=a.p.colModel.length-1;0<=g;g--)if(!a.p.colModel[g].hidden){a.p.colModel[g].resizable=!1;break}"horizontal"===a.p.viewsortcols[1]&&(V=" ui-i-asc",na=" ui-i-desc");ma=k?"class='ui-th-div-ie'":"";V="<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc"+V+" ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-"+f+"'></span>"+("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+
na+" ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-"+f+"'></span></span>");if(a.p.multiSort){aa=a.p.sortname.split(",");for(g=0;g<aa.length;g++)D=b.trim(aa[g]).split(" "),aa[g]=b.trim(D[0]),oa[g]=D[1]?b.trim(D[1]):a.p.sortorder||"asc"}for(g=0;g<this.p.colNames.length;g++)D=a.p.headertitles?' title="'+b.jgrid.stripHtml(a.p.colNames[g])+'"':"",C+="<th id='"+a.p.id+"_"+a.p.colModel[g].name+"' role='columnheader' class='ui-state-default ui-th-column ui-th-"+f+"'"+D+">",D=a.p.colModel[g].index||
a.p.colModel[g].name,C+="<div id='jqgh_"+a.p.id+"_"+a.p.colModel[g].name+"' "+ma+">"+a.p.colNames[g],a.p.colModel[g].width=a.p.colModel[g].width?parseInt(a.p.colModel[g].width,10):150,"boolean"!==typeof a.p.colModel[g].title&&(a.p.colModel[g].title=!0),a.p.colModel[g].lso="",D===a.p.sortname&&(a.p.lastsort=g),a.p.multiSort&&(D=b.inArray(D,aa),-1!==D&&(a.p.colModel[g].lso=oa[D])),C+=V+"</div></th>";V=null;b(this).append(C+"</tr></thead>");b("thead tr:first th",this).hover(function(){b(this).addClass("ui-state-hover")},
...
"false");fa.push(this.id);if(c){b("#jqg_"+b.jgrid.jqID(a.p.id)+"_"+b.jgrid.jqID(this.id),a.grid.fbDiv)[a.p.useProp?"prop":"attr"]("checked",false);b("#"+b.jgrid.jqID(this.id),a.grid.fbDiv).removeClass("ui-state-highlight")}}});a.p.selrow=null;X=false}b(a).triggerHandler("jqGridSelectAll",[X?a.p.selarrrow:fa,X]);b.isFunction(a.p.onSelectAll)&&a.p.onSelectAll.call(a,X?a.p.selarrrow:fa,X)})}!0===a.p.autowidth&&(C=b(m).innerWidth(),a.p.width=0<C?C:"nw");(function(){var d=0,e=b.jgrid.cell_width?0:n(a.p.cellLayout,
0),g=0,f,h=n(a.p.scrollOffset,0),i,k=false,m,l=0,o=0,w;b.each(a.p.colModel,function(){if(this.hidden===void 0)this.hidden=false;if(a.p.grouping&&a.p.autowidth){var c=b.inArray(this.name,a.p.groupingView.groupField);if(c>=0&&a.p.groupingView.groupColumnShow.length>c)this.hidden=!a.p.groupingView.groupColumnShow[c]}this.widthOrg=i=n(this.width,0);if(this.hidden===false){d=d+(i+e);this.fixed?l=l+(i+e):g++;o++}});if(isNaN(a.p.width))a.p.width=d+(a.p.shrinkToFit===false&&!isNaN(a.p.height)?h:0);c.width=
a.p.width;a.p.tblwidth=d;if(a.p.shrinkToFit===false&&a.p.forceFit===true)a.p.forceFit=false;if(a.p.shrinkToFit===true&&g>0){m=c.width-e*g-l;if(!isNaN(a.p.height)){m=m-h;k=true}d=0;b.each(a.p.colModel,function(b){if(this.hidden===false&&!this.fixed){this.width=i=Math.round(m*this.width/(a.p.tblwidth-e*g-l));d=d+i;f=b}});w=0;k?c.width-l-(d+e*g)!==h&&(w=c.width-l-(d+e*g)-h):!k&&Math.abs(c.width-l-(d+e*g))!==1&&(w=c.width-l-(d+e*g));a.p.colModel[f].width=a.p.colModel[f].width+w;a.p.tblwidth=d+w+e*g+l;
if(a.p.tblwidth>a.p.width){a.p.colModel[f].width=a.p.colModel[f].width-(a.p.tblwidth-parseInt(a.p.width,10));a.p.tblwidth=a.p.width}}})();b(m).css("width",c.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+a.p.id+"'>&#160;</div>");b(i).css("width",c.width+"px");var C=b("thead:first",a).get(0),P="";a.p.footerrow&&(P+="<table role='grid' style='width:"+a.p.tblwidth+"px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-"+
f+"'>");var i=b("tr:first",C),Y="<tr class='jqgfirstrow' role='row' style='height:auto'>";a.p.disableClick=!1;b("th",i).each(function(d){ca=a.p.colModel[d].width;if(a.p.colModel[d].resizable===void 0)a.p.colModel[d].resizable=true;if(a.p.colModel[d].resizable){da=document.createElement("span");b(da).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+f).css("cursor","col-resize");b(this).addClass(a.p.resizeclass)}else da="";b(this).css("width",ca+"px").prepend(da);var e="";if(a.p.colModel[d].hidden){b(this).css("display",
"none");e="display:none;"}Y=Y+("<td role='gridcell' style='height:0px;width:"+ca+"px;"+e+"'></td>");c.headers[d]={width:ca,el:this};ea=a.p.colModel[d].sortable;if(typeof ea!=="boolean")ea=a.p.colModel[d].sortable=true;e=a.p.colModel[d].name;e==="cb"||e==="subgrid"||e==="rn"||a.p.viewsortcols[2]&&b(">div",this).addClass("ui-jqgrid-sortable");if(ea)if(a.p.multiSort)if(a.p.viewsortcols[0]){b("div span.s-ico",this).show();a.p.colModel[d].lso&&b("div span.ui-icon-"+a.p.colModel[d].lso,this).removeClass("ui-state-disabled")}else{if(a.p.colModel[d].lso){b("div span.s-ico",
this).show();b("div span.ui-icon-"+a.p.colModel[d].lso,this).removeClass("ui-state-disabled")}}else if(a.p.viewsortcols[0]){b("div span.s-ico",this).show();d===a.p.lastsort&&b("div span.ui-icon-"+a.p.sortorder,this).removeClass("ui-state-disabled")}else if(d===a.p.lastsort){b("div span.s-ico",this).show();b("div span.ui-icon-"+a.p.sortorder,this).removeClass("ui-state-disabled")}a.p.footerrow&&(P=P+("<td role='gridcell' "+p(d,0,"",null,"",false)+">&#160;</td>"))}).mousedown(function(d){if(b(d.target).closest("th>span.ui-jqgrid-resize").length===
1){var e=la(this);if(a.p.forceFit===true){var g=a.p,f=e,h;for(h=e+1;h<a.p.colModel.length;h++)if(a.p.colModel[h].hidden!==true){f=h;break}g.nv=f-e}c.dragStart(e,d,sa(e));return false}}).click(function(c){if(a.p.disableClick)return a.p.disableClick=false;var d="th>div.ui-jqgrid-sortable",e,g;a.p.viewsortcols[2]||(d="th>div>span>span.ui-grid-ico-sort");c=b(c.target).closest(d);if(c.length===1){var f;if(a.p.frozenColumns){var h=b(this)[0].id.substring(5);b(a.p.colModel).each(function(a){if(this.name===
h){f=a;return false}})}else f=la(this);if(!a.p.viewsortcols[2]){e=true;g=c.attr("sort")}f!=null&&ka(b("div",this)[0].id,f,e,g,this);return false}});if(a.p.sortable&&b.fn.sortable)try{b(a).jqGrid("sortableColumns",i)}catch(xa){}a.p.footerrow&&(P+="</tr></tbody></table>");Y+="</tr>";this.appendChild(document.createElement("tbody"));b(this).addClass("ui-jqgrid-btable").append(Y);var Y=null,i=b("<table class='ui-jqgrid-htable' style='width:"+a.p.tblwidth+"px' role='grid' aria-labelledby='gbox_"+this.id+
"' cellspacing='0' cellpadding='0' border='0'></table>").append(C),H=a.p.caption&&!0===a.p.hiddengrid?!0:!1;g=b("<div class='ui-jqgrid-hbox"+("rtl"===f?"-rtl":"")+"'></div>");C=null;c.hDiv=document.createElement("div");b(c.hDiv).css({width:c.width+"px"}).addClass("ui-state-default ui-jqgrid-hdiv").append(g);b(g).append(i);i=null;H&&b(c.hDiv).hide();a.p.pager&&("string"===typeof a.p.pager?"#"!==a.p.pager.substr(0,1)&&(a.p.pager="#"+a.p.pager):a.p.pager="#"+b(a.p.pager).attr("id"),b(a.p.pager).css({width:c.width+
"px"}).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(m),H&&b(a.p.pager).hide(),ja(a.p.pager,""));!1===a.p.cellEdit&&!0===a.p.hoverrows&&b(a).bind("mouseover",function(a){u=b(a.target).closest("tr.jqgrow");b(u).attr("class")!=="ui-subgrid"&&b(u).addClass("ui-state-hover")}).bind("mouseout",function(a){u=b(a.target).closest("tr.jqgrow");b(u).removeClass("ui-state-hover")});var v,I,ga;b(a).before(c.hDiv).click(function(c){t=c.target;u=b(t,a.rows).closest("tr.jqgrow");if(b(u).length===
0||u[0].className.indexOf("ui-state-disabled")>-1||(b(t,a).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==a.id)return this;var d=b(t).hasClass("cbox"),e=b(a).triggerHandler("jqGridBeforeSelectRow",[u[0].id,c]);(e=e===false||e==="stop"?false:true)&&b.isFunction(a.p.beforeSelectRow)&&(e=a.p.beforeSelectRow.call(a,u[0].id,c));if(!(t.tagName==="A"||(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.tagName==="OPTION"||t.tagName==="SELECT")&&!d)&&e===true){v=u[0].id;I=b.jgrid.getCellIndex(t);
ga=b(t).closest("td,th").html();b(a).triggerHandler("jqGridCellSelect",[v,I,ga,c]);b.isFunction(a.p.onCellSelect)&&a.p.onCellSelect.call(a,v,I,ga,c);if(a.p.cellEdit===true)if(a.p.multiselect&&d)b(a).jqGrid("setSelection",v,true,c);else{v=u[0].rowIndex;try{b(a).jqGrid("editCell",v,I,true)}catch(g){}}else if(a.p.multikey)if(c[a.p.multikey])b(a).jqGrid("setSelection",v,true,c);else{if(a.p.multiselect&&d){d=b("#jqg_"+b.jgrid.jqID(a.p.id)+"_"+v).is(":checked");b("#jqg_"+b.jgrid.jqID(a.p.id)+"_"+v)[a.p.useProp?
...
document.createElement("div");var ha=!0===a.p.hidegrid?b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(function(){ha.addClass("ui-state-hover")},function(){ha.removeClass("ui-state-hover")}).append("<span class='ui-icon ui-icon-circle-triangle-n'></span>").css("rtl"===f?"left":"right","0px"):"";b(c.cDiv).append(ha).append("<span class='ui-jqgrid-title"+("rtl"===f?"-rtl":"")+"'>"+a.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix");
...
"hidden"&&b(g,"#gbox_"+b.jgrid.jqID(a.p.id)).slideDown("fast",function(){f--;if(f===0){b("span",h).removeClass("ui-icon-circle-triangle-s").addClass("ui-icon-circle-triangle-n");if(H){a.p.datatype=ta;N();H=false}a.p.gridstate="visible";b("#gbox_"+b.jgrid.jqID(a.p.id)).hasClass("ui-resizable")&&b(".ui-resizable-handle","#gbox_"+b.jgrid.jqID(a.p.id)).show();b(a).triggerHandler("jqGridHeaderClick",[a.p.gridstate,d]);e&&(H||a.p.onHeaderClick.call(a,a.p.gridstate,d))}});return false}),H&&(a.p.datatype=
"local",b(".ui-jqgrid-titlebar-close",c.cDiv).trigger("click")))}else b(c.cDiv).hide();b(c.hDiv).after(c.bDiv).mousemove(function(a){if(c.resizing){c.dragMove(a);return false}});b(".ui-jqgrid-labels",c.hDiv).bind("selectstart",function(){return false});b(document).mouseup(function(){if(c.resizing){c.dragEnd();return false}return true});a.formatCol=p;a.sortData=ka;a.updatepager=function(c,d){var e,g,f,h,i,j,k,m="",l=a.p.pager?"_"+b.jgrid.jqID(a.p.pager.substr(1)):"",o=a.p.toppager?"_"+a.p.toppager.substr(1):
...
"";if(m=m+(a.p.toppager?m?","+a.p.toppager:a.p.toppager:"")){k=b.jgrid.formatter.integer||{};e=n(a.p.page);g=n(a.p.lastpage);b(".selbox",m)[this.p.useProp?"prop":"attr"]("disabled",false);if(a.p.pginput===true){b(".ui-pg-input",m).val(a.p.page);h=a.p.toppager?"#sp_1"+l+",#sp_1"+o:"#sp_1"+l;b(h).html(b.fmatter?b.fmatter.util.NumberFormat(a.p.lastpage,k):a.p.lastpage)}if(a.p.viewrecords)if(a.p.reccount===0)b(".ui-paging-info",m).html(a.p.emptyrecords);else{h=f+1;j=a.p.records;if(b.fmatter){h=b.fmatter.util.NumberFormat(h,
k);i=b.fmatter.util.NumberFormat(i,k);j=b.fmatter.util.NumberFormat(j,k)}b(".ui-paging-info",m).html(b.jgrid.format(a.p.recordtext,h,i,j))}if(a.p.pgbuttons===true){e<=0&&(e=g=0);if(e===1||e===0){b("#first"+l+", #prev"+l).addClass("ui-state-disabled").removeClass("ui-state-hover");a.p.toppager&&b("#first_t"+o+", #prev_t"+o).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{b("#first"+l+", #prev"+l).removeClass("ui-state-disabled");a.p.toppager&&b("#first_t"+o+", #prev_t"+o).removeClass("ui-state-disabled")}if(e===
g||e===0){b("#next"+l+", #last"+l).addClass("ui-state-disabled").removeClass("ui-state-hover");a.p.toppager&&b("#next_t"+o+", #last_t"+o).addClass("ui-state-disabled").removeClass("ui-state-hover")}else{b("#next"+l+", #last"+l).removeClass("ui-state-disabled");a.p.toppager&&b("#next_t"+o+", #last_t"+o).removeClass("ui-state-disabled")}}}c===true&&a.p.rownumbers===true&&b(">td.jqgrid-rownum",a.rows).each(function(a){b(this).html(f+1+a)});d&&a.p.jqgdnd&&b(a).jqGrid("gridDnD","updateDnD");b(a).triggerHandler("jqGridGridComplete");
b.isFunction(a.p.gridComplete)&&a.p.gridComplete.call(a);b(a).triggerHandler("jqGridAfterGridComplete")};a.refreshIndex=M;a.setHeadCheckBox=ba;a.constructTr=W;a.formatter=function(a,b,c,d,e){return o(a,b,c,d,e)};b.extend(c,{populate:N,emptyRows:U});this.grid=c;a.addXmlData=function(b){J(b,a.grid.bDiv)};a.addJSONData=function(b){R(b,a.grid.bDiv)};this.grid.cols=this.rows[0].cells;b(a).triggerHandler("jqGridInitGrid");b.isFunction(a.p.onInitGrid)&&a.p.onInitGrid.call(a);N();a.p.hiddengrid=!1}}}})};
...
this.p._index[b.jgrid.stripPref(this.p.idPrefix,d)];void 0!==a&&(this.p.data.splice(a,1),this.refreshIndex())}if(!0===this.p.altRows&&f){var j=this.p.altclass;b(this.rows).each(function(a){a%2===1?b(this).addClass(j):b(this).removeClass(j)})}});return f},setRowData:function(d,f,c){var e,a=!0,j;this.each(function(){if(!this.grid)return!1;var g=this,h,i,k=typeof c,m={};i=g.rows.namedItem(d);if(!i)return!1;if(f)try{if(b(this.p.colModel).each(function(a){e=this.name;var c=b.jgrid.getAccessor(f,e);void 0!==
c&&(m[e]=this.formatter&&"string"===typeof this.formatter&&"date"===this.formatter?b.unformat.date.call(g,c,this):c,h=g.formatter(d,c,a,f,"edit"),j=this.title?{title:b.jgrid.stripHtml(h)}:{},!0===g.p.treeGrid&&e===g.p.ExpandColumn?b("td[role='gridcell']:eq("+a+") > span:first",i).html(h).attr(j):b("td[role='gridcell']:eq("+a+")",i).html(h).attr(j))}),"local"===g.p.datatype){var n=b.jgrid.stripPref(g.p.idPrefix,d),p=g.p._index[n],l;if(g.p.treeGrid)for(l in g.p.treeReader)g.p.treeReader.hasOwnProperty(l)&&
delete m[g.p.treeReader[l]];void 0!==p&&(g.p.data[p]=b.extend(!0,g.p.data[p],m));m=null}}catch(o){a=!1}a&&("string"===k?b(i).addClass(c):"object"===k&&b(i).css(c),b(g).triggerHandler("jqGridAfterGridComplete"))});return a},addRowData:function(d,f,c,e){c||(c="last");var a=!1,j,g,h,i,k,m,n,p,l="",o,B,S,L,Z,T;f&&(b.isArray(f)?(o=!0,c="last",B=d):(f=[f],o=!1),this.each(function(){var U=f.length;k=this.p.rownumbers===true?1:0;h=this.p.multiselect===true?1:0;i=this.p.subGrid===true?1:0;if(!o)if(d!==void 0)d=
""+d;else{d=b.jgrid.randId();if(this.p.keyIndex!==false){B=this.p.colModel[this.p.keyIndex+h+i+k].name;f[0][B]!==void 0&&(d=f[0][B])}}S=this.p.altclass;for(var M=0,W="",J={},R=b.isFunction(this.p.afterInsertRow)?true:false;M<U;){L=f[M];g=[];if(o){try{d=L[B];d===void 0&&(d=b.jgrid.randId())}catch(ia){d=b.jgrid.randId()}W=this.p.altRows===true?(this.rows.length-1)%2===0?S:"":""}T=d;d=this.p.idPrefix+d;if(k){l=this.formatCol(0,1,"",null,d,true);g[g.length]='<td role="gridcell" class="ui-state-default jqgrid-rownum" '+
l+">0</td>"}if(h){p='<input role="checkbox" type="checkbox" id="jqg_'+this.p.id+"_"+d+'" class="cbox"/>';l=this.formatCol(k,1,"",null,d,true);g[g.length]='<td role="gridcell" '+l+">"+p+"</td>"}i&&(g[g.length]=b(this).jqGrid("addSubGridCell",h+k,1));for(n=h+i+k;n<this.p.colModel.length;n++){Z=this.p.colModel[n];j=Z.name;J[j]=L[j];p=this.formatter(d,b.jgrid.getAccessor(L,j),n,L);l=this.formatCol(n,1,p,L,d,J);g[g.length]='<td role="gridcell" '+l+">"+p+"</td>"}g.unshift(this.constructTr(d,false,W,J,L,
false));g[g.length]="</tr>";if(this.rows.length===0)b("table:first",this.grid.bDiv).append(g.join(""));else switch(c){case "last":b(this.rows[this.rows.length-1]).after(g.join(""));m=this.rows.length-1;break;case "first":b(this.rows[0]).after(g.join(""));m=1;break;case "after":(m=this.rows.namedItem(e))&&(b(this.rows[m.rowIndex+1]).hasClass("ui-subgrid")?b(this.rows[m.rowIndex+1]).after(g):b(m).after(g.join("")));m++;break;case "before":if(m=this.rows.namedItem(e)){b(m).before(g.join(""));m=m.rowIndex}m--}this.p.subGrid===
true&&b(this).jqGrid("addSubGrid",h+k,m);this.p.records++;this.p.reccount++;b(this).triggerHandler("jqGridAfterInsertRow",[d,L,L]);R&&this.p.afterInsertRow.call(this,d,L,L);M++;if(this.p.datatype==="local"){J[this.p.localReader.id]=T;this.p._index[T]=this.p.data.length;this.p.data.push(J);J={}}}this.p.altRows===true&&!o&&(c==="last"?(this.rows.length-1)%2===1&&b(this.rows[this.rows.length-1]).addClass(S):b(this.rows).each(function(a){a%2===1?b(this).addClass(S):b(this).removeClass(S)}));this.updatepager(true,
...
k)}catch(p){a=b.jgrid.htmlDecode(this.rows[n].cells[k].innerHTML)}c?(i=parseFloat(a),j+=i,void 0===h&&(h=g=i),g=Math.min(g,i),h=Math.max(h,i)):f?e.push({id:this.rows[n].id,value:a}):e.push(a)}n++}if(c)switch(c.toLowerCase()){case "sum":e=j;break;case "avg":e=j/m;break;case "count":e=m;break;case "min":e=g;break;case "max":e=h}}}});return e},clearGridData:function(d){return this.each(function(){if(this.grid){"boolean"!==typeof d&&(d=!1);if(this.p.deepempty)b("#"+b.jgrid.jqID(this.p.id)+" tbody:first tr:gt(0)").remove();
...
le:"<=",gt:">",ge:">=",bw:"^",bn:"!^","in":"=",ni:"!=",ew:"|",en:"!@",cn:"~",nc:"!~",nu:"#",nn:"!#"}},a.jgrid.search,b||{});return this.each(function(){var c=this;if(!this.ftoolbar){var e=function(){var h={},f=0,e,k,j={},i;a.each(c.p.colModel,function(){var d=a("#gs_"+a.jgrid.jqID(this.name),!0===this.frozen&&!0===c.p.frozenColumns?c.grid.fhDiv:c.grid.hDiv);k=this.index||this.name;i=b.searchOperators?d.parent().prev().children("a").attr("soper")||b.defaultSearch:this.searchoptions&&this.searchoptions.sopt?
this.searchoptions.sopt[0]:"select"===this.stype?"eq":b.defaultSearch;if((e="custom"===this.stype&&a.isFunction(this.searchoptions.custom_value)&&0<d.length&&"SPAN"===d[0].nodeName.toUpperCase()?this.searchoptions.custom_value.call(c,d.children(".customelement:first"),"get"):d.val())||"nu"===i||"nn"===i)h[k]=e,j[k]=i,f++;else try{delete c.p.postData[k]}catch(l){}});var l=0<f?!0:!1;if(!0===b.stringResult||"local"===c.p.datatype){var d='{"groupOp":"'+b.groupOp+'","rules":[',g=0;a.each(h,function(a,
b){0<g&&(d+=",");d+='{"field":"'+a+'",';d+='"op":"'+j[a]+'",';d+='"data":"'+(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}';g++});d+="]}";a.extend(c.p.postData,{filters:d});a.each(["searchField","searchString","searchOper"],function(a,b){c.p.postData.hasOwnProperty(b)&&delete c.p.postData[b]})}else a.extend(c.p.postData,h);var o;c.p.searchurl&&(o=c.p.url,a(c).jqGrid("setGridParam",{url:c.p.searchurl}));var n="stop"===a(c).triggerHandler("jqGridToolbarBeforeSearch")?!0:!1;!n&&a.isFunction(b.beforeSearch)&&
(n=b.beforeSearch.call(c));n||a(c).jqGrid("setGridParam",{search:l}).trigger("reloadGrid",[{page:1}]);o&&a(c).jqGrid("setGridParam",{url:o});a(c).triggerHandler("jqGridToolbarAfterSearch");a.isFunction(b.afterSearch)&&b.afterSearch.call(c)},g=function(h,f,d){a("#sopt_menu").remove();var f=parseInt(f,10),d=parseInt(d,10)+18,f='<ul id="sopt_menu" class="ui-search-menu" role="menu" tabindex="0" style="font-size:'+(a(".ui-jqgrid-view").css("font-size")||"11px")+";left:"+f+"px;top:"+d+'px;">',d=a(h).attr("soper"),
k,j=[],i,l;i=0;var g=a(h).attr("colname");for(k=c.p.colModel.length;i<k&&c.p.colModel[i].name!==g;)i++;i=c.p.colModel[i];g=a.extend({},i.searchoptions);g.sopt||(g.sopt=[],g.sopt[0]="select"===i.stype?"eq":b.defaultSearch);a.each(b.odata,function(){j.push(this.oper)});for(i=0;i<g.sopt.length;i++)l=a.inArray(g.sopt[i],j),-1!==l&&(k=d===b.odata[l].oper?"ui-state-highlight":"",f+='<li class="ui-menu-item '+k+'" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="'+
b.odata[l].oper+'" oper="'+b.operands[b.odata[l].oper]+'"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">'+b.operands[b.odata[l].oper]+"</td><td>"+b.odata[l].text+"</td></tr></table></a></li>");a("body").append(f+"</ul>");a("#sopt_menu").addClass("ui-menu ui-widget ui-widget-content ui-corner-all");a("#sopt_menu > li > a").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")}).click(function(){var f=a(this).attr("value"),d=a(this).attr("oper");
a(c).triggerHandler("jqGridToolbarSelectOper",[f,d,h]);a("#sopt_menu").hide();a(h).text(d).attr("soper",f);if(b.autosearch===true){d=a(h).parent().next().children()[0];(a(d).val()||f==="nu"||f==="nn")&&e()}})},j=a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),d;a.each(c.p.colModel,function(){var h=this,f,g;g="";var k="=",s=a("<th role='columnheader' class='ui-state-default ui-th-column ui-th-"+c.p.direction+"'></th>"),i=a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),
l=a("<table class='ui-search-table' cellspacing='0'><tr><td class='ui-search-oper'></td><td class='ui-search-input'></td></tr></table>");!0===this.hidden&&a(s).css("display","none");this.search=!1===this.search?!1:!0;void 0===this.stype&&(this.stype="text");f=a.extend({},this.searchoptions||{});if(this.search){if(b.searchOperators){g=f.sopt?f.sopt[0]:"select"===h.stype?"eq":b.defaultSearch;for(var p=0;p<b.odata.length;p++)if(b.odata[p].oper===g){k=b.operands[g]||"";break}g="<a title='"+(null!=f.searchtitle?
f.searchtitle:b.operandTitle)+"' style='padding-right: 0.5em;' soper='"+g+"' class='soptclass' colname='"+this.name+"'>"+k+"</a>"}a("td:eq(0)",l).append(g);switch(this.stype){case "select":if(g=this.surl||f.dataUrl)a.ajax(a.extend({url:g,dataType:"html",success:function(d){if(f.buildSelect!==void 0){if(d=f.buildSelect(d)){a("td:eq(1)",l).append(d);a(i).append(l)}}else{a("td:eq(1)",l).append(d);a(i).append(l)}f.defaultValue!==void 0&&a("select",i).val(f.defaultValue);a("select",i).attr({name:h.index||
h.name,id:"gs_"+h.name});f.attr&&a("select",i).attr(f.attr);a("select",i).css({width:"100%"});a.jgrid.bindEv.call(c,a("select",i)[0],f);b.autosearch===true&&a("select",i).change(function(){e();return false});d=null}},a.jgrid.ajaxOptions,c.p.ajaxSelectOptions||{}));else{var m,o,n;h.searchoptions?(m=void 0===h.searchoptions.value?"":h.searchoptions.value,o=void 0===h.searchoptions.separator?":":h.searchoptions.separator,n=void 0===h.searchoptions.delimiter?";":h.searchoptions.delimiter):h.editoptions&&
(m=void 0===h.editoptions.value?"":h.editoptions.value,o=void 0===h.editoptions.separator?":":h.editoptions.separator,n=void 0===h.editoptions.delimiter?";":h.editoptions.delimiter);if(m){k=document.createElement("select");k.style.width="100%";a(k).attr({name:h.index||h.name,id:"gs_"+h.name});var r;if("string"===typeof m){g=m.split(n);for(r=0;r<g.length;r++)m=g[r].split(o),n=document.createElement("option"),n.value=m[0],n.innerHTML=m[1],k.appendChild(n)}else if("object"===typeof m)for(r in m)m.hasOwnProperty(r)&&
(n=document.createElement("option"),n.value=r,n.innerHTML=m[r],k.appendChild(n));void 0!==f.defaultValue&&a(k).val(f.defaultValue);f.attr&&a(k).attr(f.attr);a.jgrid.bindEv.call(c,k,f);a("td:eq(1)",l).append(k);a(i).append(l);!0===b.autosearch&&a(k).change(function(){e();return false})}}break;case "text":o=void 0!==f.defaultValue?f.defaultValue:"";a("td:eq(1)",l).append("<input type='text' style='width:100%;padding:0px;' name='"+(h.index||h.name)+"' id='gs_"+h.name+"' value='"+o+"'/>");a(i).append(l);
f.attr&&a("input",i).attr(f.attr);a.jgrid.bindEv.call(c,a("input",i)[0],f);!0===b.autosearch&&(b.searchOnEnter?a("input",i).keypress(function(a){if((a.charCode||a.keyCode||0)===13){e();return false}return this}):a("input",i).keydown(function(a){switch(a.which){case 13:return false;case 9:case 16:case 37:case 38:case 39:case 40:case 27:break;default:d&&clearTimeout(d);d=setTimeout(function(){e()},500)}}));break;case "custom":a("td:eq(1)",l).append("<span style='width:95%;padding:0px;' name='"+(h.index||
h.name)+"' id='gs_"+h.name+"'/>");a(i).append(l);try{if(a.isFunction(f.custom_element)){var u=f.custom_element.call(c,void 0!==f.defaultValue?f.defaultValue:"",f);if(u)u=a(u).addClass("customelement"),a(i).find(">span").append(u);else throw"e2";}else throw"e1";}catch(t){"e1"===t&&a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.nodefined,a.jgrid.edit.bClose),"e2"===t?a.jgrid.info_dialog(a.jgrid.errors.errcap,"function 'custom_element' "+a.jgrid.edit.msg.novalue,
a.jgrid.edit.bClose):a.jgrid.info_dialog(a.jgrid.errors.errcap,"string"===typeof t?t:t.message,a.jgrid.edit.bClose)}}}a(s).append(i);a(j).append(s);b.searchOperators||a("td:eq(0)",l).hide()});a("table thead",c.grid.hDiv).append(j);b.searchOperators&&(a(".soptclass").click(function(b){var c=a(this).offset();g(this,c.left,c.top);b.stopPropagation()}),a("body").on("click",function(b){"soptclass"!==b.target.className&&a("#sopt_menu").hide()}));this.ftoolbar=!0;this.triggerToolbar=e;this.clearToolbar=
function(d){var f={},e=0,g,d=typeof d!=="boolean"?true:d;a.each(c.p.colModel,function(){var b,d=a("#gs_"+a.jgrid.jqID(this.name),this.frozen===true&&c.p.frozenColumns===true?c.grid.fhDiv:c.grid.hDiv);if(this.searchoptions&&this.searchoptions.defaultValue!==void 0)b=this.searchoptions.defaultValue;g=this.index||this.name;switch(this.stype){case "select":d.find("option").each(function(c){if(c===0)this.selected=true;if(a(this).val()===b){this.selected=true;return false}});if(b!==void 0){f[g]=b;e++}else try{delete c.p.postData[g]}catch(h){}break;
case "text":d.val(b);if(b!==void 0){f[g]=b;e++}else try{delete c.p.postData[g]}catch(i){}break;case "custom":a.isFunction(this.searchoptions.custom_value)&&d.length>0&&d[0].nodeName.toUpperCase()==="SPAN"&&this.searchoptions.custom_value.call(c,d.children(".customelement:first"),"set",b)}});var j=e>0?true:false;if(b.stringResult===true||c.p.datatype==="local"){var i='{"groupOp":"'+b.groupOp+'","rules":[',l=0;a.each(f,function(a,b){l>0&&(i=i+",");i=i+('{"field":"'+a+'",');i=i+'"op":"eq",';i=i+('"data":"'+
(b+"").replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}');l++});i=i+"]}";a.extend(c.p.postData,{filters:i});a.each(["searchField","searchString","searchOper"],function(a,b){c.p.postData.hasOwnProperty(b)&&delete c.p.postData[b]})}else a.extend(c.p.postData,f);var p;if(c.p.searchurl){p=c.p.url;a(c).jqGrid("setGridParam",{url:c.p.searchurl})}var m=a(c).triggerHandler("jqGridToolbarBeforeClear")==="stop"?true:false;!m&&a.isFunction(b.beforeClear)&&(m=b.beforeClear.call(c));m||d&&a(c).jqGrid("setGridParam",
{search:j}).trigger("reloadGrid",[{page:1}]);p&&a(c).jqGrid("setGridParam",{url:p});a(c).triggerHandler("jqGridToolbarAfterClear");a.isFunction(b.afterClear)&&b.afterClear()};this.toggleToolbar=function(){var b=a("tr.ui-search-toolbar",c.grid.hDiv),d=c.p.frozenColumns===true?a("tr.ui-search-toolbar",c.grid.fhDiv):false;if(b.css("display")==="none"){b.show();d&&d.show()}else{b.hide();d&&d.hide()}}}})},destroyFilterToolbar:function(){return this.each(function(){this.ftoolbar&&(this.toggleToolbar=this.clearToolbar=
this.triggerToolbar=null,this.ftoolbar=!1,a(this.grid.hDiv).find("table thead tr.ui-search-toolbar").remove())})},destroyGroupHeader:function(b){void 0===b&&(b=!0);return this.each(function(){var c,e,g,j,d,h;e=this.grid;var f=a("table.ui-jqgrid-htable thead",e.hDiv),q=this.p.colModel;if(e){a(this).unbind(".setGroupHeaders");c=a("<tr>",{role:"rowheader"}).addClass("ui-jqgrid-labels");j=e.headers;e=0;for(g=j.length;e<g;e++){d=q[e].hidden?"none":"";d=a(j[e].el).width(j[e].width).css("display",d);try{d.removeAttr("rowSpan")}catch(k){d.attr("rowSpan",
1)}c.append(d);h=d.children("span.ui-jqgrid-resize");0<h.length&&(h[0].style.height="");d.children("div")[0].style.top=""}a(f).children("tr.ui-jqgrid-labels").remove();a(f).prepend(c);!0===b&&a(this).jqGrid("setGridParam",{groupHeader:null})}})},setGroupHeaders:function(b){b=a.extend({useColSpanStyle:!1,groupHeaders:[]},b||{});return this.each(function(){this.p.groupHeader=b;var c,e,g=0,j,d,h,f,q,k=this.p.colModel,s=k.length,i=this.grid.headers,l=a("table.ui-jqgrid-htable",this.grid.hDiv),p=l.children("thead").children("tr.ui-jqgrid-labels:last").addClass("jqg-second-row-header");
j=l.children("thead");var m=l.find(".jqg-first-row-header");void 0===m[0]?m=a("<tr>",{role:"row","aria-hidden":"true"}).addClass("jqg-first-row-header").css("height","auto"):m.empty();var o,n=function(a,b){var c=b.length,d;for(d=0;d<c;d++)if(b[d].startColumnName===a)return d;return-1};a(this).prepend(j);j=a("<tr>",{role:"rowheader"}).addClass("ui-jqgrid-labels jqg-third-row-header");for(c=0;c<s;c++)if(h=i[c].el,f=a(h),e=k[c],d={height:"0px",width:i[c].width+"px",display:e.hidden?"none":""},a("<th>",
{role:"gridcell"}).css(d).addClass("ui-first-th-"+this.p.direction).appendTo(m),h.style.width="",d=n(e.name,b.groupHeaders),0<=d){d=b.groupHeaders[d];g=d.numberOfColumns;q=d.titleText;for(d=e=0;d<g&&c+d<s;d++)k[c+d].hidden||e++;d=a("<th>").attr({role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+this.p.direction).css({height:"22px","border-top":"0px none"}).html(q);0<e&&d.attr("colspan",""+e);this.p.headertitles&&d.attr("title",d.text());0===e&&d.hide();f.before(d);j.append(h);
g-=1}else 0===g?b.useColSpanStyle?f.attr("rowspan","2"):(a("<th>",{role:"columnheader"}).addClass("ui-state-default ui-th-column-header ui-th-"+this.p.direction).css({display:e.hidden?"none":"","border-top":"0px none"}).insertBefore(f),j.append(h)):(j.append(h),g--);k=a(this).children("thead");k.prepend(m);j.insertAfter(p);l.append(k);b.useColSpanStyle&&(l.find("span.ui-jqgrid-resize").each(function(){var b=a(this).parent();b.is(":visible")&&(this.style.cssText="height: "+b.height()+"px !important; cursor: col-resize;")}),
l.find("div.ui-jqgrid-sortable").each(function(){var b=a(this),c=b.parent();c.is(":visible")&&c.is(":has(span.ui-jqgrid-resize)")&&b.css("top",(c.height()-b.outerHeight())/2+"px")}));o=k.find("tr.jqg-first-row-header");a(this).bind("jqGridResizeStop.setGroupHeaders",function(a,b,c){o.find("th").eq(c).width(b)})})},setFrozenColumns:function(){return this.each(function(){if(this.grid){var b=this,c=b.p.colModel,e=0,g=c.length,j=-1,d=!1;if(!(!0===b.p.subGrid||!0===b.p.treeGrid||!0===b.p.cellEdit||b.p.sortable||
b.p.scroll||b.p.grouping)){b.p.rownumbers&&e++;for(b.p.multiselect&&e++;e<g;){if(!0===c[e].frozen)d=!0,j=e;else break;e++}if(0<=j&&d){c=b.p.caption?a(b.grid.cDiv).outerHeight():0;e=a(".ui-jqgrid-htable","#gview_"+a.jgrid.jqID(b.p.id)).height();b.p.toppager&&(c+=a(b.grid.topDiv).outerHeight());!0===b.p.toolbar[0]&&"bottom"!==b.p.toolbar[1]&&(c+=a(b.grid.uDiv).outerHeight());b.grid.fhDiv=a('<div style="position:absolute;left:0px;top:'+c+"px;height:"+e+'px;" class="frozen-div ui-state-default ui-jqgrid-hdiv"></div>');
b.grid.fbDiv=a('<div style="position:absolute;left:0px;top:'+(parseInt(c,10)+parseInt(e,10)+1)+'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>');a("#gview_"+a.jgrid.jqID(b.p.id)).append(b.grid.fhDiv);c=a(".ui-jqgrid-htable","#gview_"+a.jgrid.jqID(b.p.id)).clone(!0);if(b.p.groupHeader){a("tr.jqg-first-row-header, tr.jqg-third-row-header",c).each(function(){a("th:gt("+j+")",this).remove()});var h=-1,f=-1,q,k;a("tr.jqg-second-row-header th",c).each(function(){q=parseInt(a(this).attr("colspan"),
10);if(k=parseInt(a(this).attr("rowspan"),10))h++,f++;q&&(h+=q,f++);if(h===j)return!1});h!==j&&(f=j);a("tr.jqg-second-row-header",c).each(function(){a("th:gt("+f+")",this).remove()})}else a("tr",c).each(function(){a("th:gt("+j+")",this).remove()});a(c).width(1);a(b.grid.fhDiv).append(c).mousemove(function(a){if(b.grid.resizing)return b.grid.dragMove(a),!1});a(b).bind("jqGridResizeStop.setFrozenColumns",function(c,d,e){c=a(".ui-jqgrid-htable",b.grid.fhDiv);a("th:eq("+e+")",c).width(d);c=a(".ui-jqgrid-btable",
...
a.each(j,function(c,b){j[c]=a.jgrid.htmlDecode(b)});if(j[m]===h.addoper){l[2]||(l[2]=a.jgrid.randId());j[i]=l[2];b[d.p.id].reloadAfterSubmit?a(d).trigger("reloadGrid"):d.p.treeGrid===true?a(d).jqGrid("addChildNode",l[2],o,j):a(d).jqGrid("addRowData",l[2],j,c.addedrow);if(b[d.p.id].closeAfterAdd){d.p.treeGrid!==true&&a(d).jqGrid("setSelection",l[2]);a.jgrid.hideModal("#"+a.jgrid.jqID(p.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:c.jqModal,onClose:b[d.p.id].onClose})}else b[d.p.id].clearAfterAdd&&t("_empty",
d,f)}else{if(b[d.p.id].reloadAfterSubmit){a(d).trigger("reloadGrid");b[d.p.id].closeAfterEdit||setTimeout(function(){a(d).jqGrid("setSelection",j[i])},1E3)}else d.p.treeGrid===true?a(d).jqGrid("setTreeRow",j[i],j):a(d).jqGrid("setRowData",j[i],j);b[d.p.id].closeAfterEdit&&a.jgrid.hideModal("#"+a.jgrid.jqID(p.themodal),{gb:"#gbox_"+a.jgrid.jqID(q),jqm:c.jqModal,onClose:b[d.p.id].onClose})}if(a.isFunction(b[d.p.id].afterComplete)){e=g;setTimeout(function(){a(d).triggerHandler("jqGridAddEditAfterComplete",
