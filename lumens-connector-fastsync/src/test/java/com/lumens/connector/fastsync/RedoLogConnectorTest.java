...
import com.lumens.connector.fastsync.FastSyncConstants;
...
import com.lumens.connector.fastsync.impl.Metadata;
import com.lumens.connector.fastsync.impl.Constants;
import com.lumens.connector.fastsync.impl.TestBase;
 ...
 */
public class RedoLogConnectorTest extends TestBase implements FastSyncConstants, Constants {
    ...
    public void testConnectorReadSync() {
        ...
        ConnectorFactory connectorFactory = new FastSyncConnectorFactory();
