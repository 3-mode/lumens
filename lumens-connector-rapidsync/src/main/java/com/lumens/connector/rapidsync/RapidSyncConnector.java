...
import com.lumens.connector.rapidsync.api.LogMinerFactory;
import com.lumens.connector.rapidsync.api.Config;
import com.lumens.connector.rapidsync.api.ConfigFactory;
 ...
 */
public class RapidSyncConnector implements Connector, RapidSyncConstants {

    private final Logger log = SysLogFactory.getLogger(RapidSyncConnector.class);
    ...
    public Operation getOperation() {
        return new RapidSyncOperation(miner);
    }
