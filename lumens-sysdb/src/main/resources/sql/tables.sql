...
CREATE TABLE LUNS_JOB_PROJECT_RELATION (
...
CREATE TABLE LUNS_ELEM_EXCEPTION_LOG (
     "LOG_ID" BIGINT NOT NULL,
     "EXCEP_MESSAGE" LONG VARCHAR,
     "COMPONENT_ID" BIGINT NOT NULL,
     "COMPONENT_NAME" VARCHAR(512) NOT NULL,
     "TARGET_NAME" VARCHAR(512),
     "DIRECTION" VARCHAR(5) NOT NULL,
...
CREATE TABLE LUNS_CONFIGURATION (
    "ID" BIGINT NOT NULL, 
